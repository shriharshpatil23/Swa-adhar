...
ganache_url = "http://127.0.0.1:7545"  # or your custom Ganache URL
web3 = Web3(Web3.HTTPProvider(ganache_url))
contract_address = "0xbEd4282BD8c950Da9aaF0B4597ba20C91086794e"  # the address of your deployed contract
# Load the contract ABI
contract_abi = json.load(open('client\src\contracts\optimized_healthCare.json'))
...
def docverify():
        ...
        # print(pkey)        
        tx_hash = contract.functions.signupDoctor(name).transact({'from': pkey})
        receipt = web3.eth.get_transaction_receipt(tx_hash)
        # print(tx_hash)
        print(receipt)
        
        # print('*****')
        # retdata = contract.functions.getPatientInfo().call({'from' :pkey })
        # print(retdata)
